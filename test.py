...
def circ():
  ...
  #final result
    if a==1:
      print("Circumference of circle of radius \n" +(b)+ " is "+ str(2*pi*int(b)))
    elif a==2:
      print("Area of circle of radius \n"+(b)+ " is "+ str(pi*int(b)**2))
    elif a==3:
      print("Surface area of sphere of radius \n"+(b)+" is "+str(4*pi*int(b)**2))
    elif a==(4):
      print("Volume of sphere of radius \n"+(b)+" is "+ str(4/3 *pi*int(b)**3))
    else:
